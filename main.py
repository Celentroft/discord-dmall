...
╚═════╝ ╚═╝╚══════╝ ╚═════╝ ╚═════╝ ╚═╝  ╚═╝╚═════╝     ╚═════╝ ╚═╝     ╚═╝    ╚═╝  ╚═╝╚══════╝╚══════╝    
                                                                                          by Celentroft
                                                    Github: https://github.com/Celentroft/discord-dmall
"""
...
async def on_ready():
    ...
    if guild:
        await bot.change_presence(activity=discord.Game(name=config['status'] if config['status'] != "" else "discord.gg/purity-dev"))
